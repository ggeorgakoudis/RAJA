...
#ifndef RAJA_scan_apollo_cuda_HPP
#define RAJA_scan_apollo_cuda_HPP
...
void inclusive_inplace(const ::RAJA::apollo_cuda_exec<BLOCK_SIZE, Async>&,
                       InputIter begin,
                       InputIter end,
                       Function binary_op)
{
...
template <size_t BLOCK_SIZE,
          ...
          typename Function,
          typename T>
void exclusive_inplace(const ::RAJA::apollo_cuda_exec<BLOCK_SIZE, Async>&,
                       InputIter begin,
                       InputIter end,
                       Function binary_op,
                       T init)
...
template <size_t BLOCK_SIZE,
          ...
          typename OutputIter,
          typename Function>
void inclusive(const ::RAJA::apollo_cuda_exec<BLOCK_SIZE, Async>&,
               InputIter begin,
               InputIter end,
               OutputIter out,
               Function binary_op)
...
template <size_t BLOCK_SIZE,
          ...
          typename Function,
          typename T>
void exclusive(const ::RAJA::apollo_cuda_exec<BLOCK_SIZE, Async>&,
               InputIter begin,
               InputIter end,
               OutputIter out,
               Function binary_op,
